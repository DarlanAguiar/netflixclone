        ...
        <div className="featured--horizontal">
          ...
          <div className="featured--info">
            ...
            <div className="feature--buttons">
              <a className="botao--assistir" href={`/watch/${item.id}`}><BsPlayFill /> Assistir</a>
              <a className="botao--lista" href={`/list/${item.id}`}><BsPlus /> Minha Lista </a>
            </div>

            <div className="featured--genres">
              <strong>Gênero:</strong> {generosJuntos.length > 0 ? `${generosJuntos}`  : "Sem Classifição"}
            </div>
          </div>
        </div>
      </div>
